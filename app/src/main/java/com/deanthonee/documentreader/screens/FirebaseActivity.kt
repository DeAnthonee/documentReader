...
class FirebaseActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Picasso.get().load(TEST_PIC_URL).into(imageView)
...
//                uri
//            )
            val something = imageView.drawable.toBitmap()
            image = FirebaseVisionImage.fromBitmap(something)
            ...
            textRecognizer.processImage(image).addOnSuccessListener {
                ...
                startActivity(ResultsActivity.newIntent(it.text, this@FirebaseActivity))
    ...
    companion object {
        fun newIntent(callingActivity: Context) = Intent(callingActivity, FirebaseActivity::class.java)
